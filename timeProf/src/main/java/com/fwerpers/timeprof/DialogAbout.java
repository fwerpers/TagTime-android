...
public class DialogAbout extends AlertDialog {
    ...
    public DialogAbout(final Context context, int theme) {
        ...
        Context appctx = TimeProf.getAppContext();
        ...
        rate.setOnClickListener( new View.OnClickListener() {
            public void onClick( View view ) {
                context.startActivity( new Intent( Intent.ACTION_VIEW, Uri
                        .parse( "market://details?id=" + TimeProf.APP_PNAME ) ) );
                dismiss();
            }
        } );
        setView( newview );
        ...
        setButton( BUTTON_POSITIVE, TimeProf.getAppContext().getText(R.string.about_dismiss), (new OnClickListener() {
            public void onClick( DialogInterface dialog, int which ) {
                dismiss();
            }
        }) );
//
//        setButton( BUTTON_NEUTRAL, TimeProf.getAppContext().getText(R.string.about_changelog), (new OnClickListener() {
//            public void onClick( DialogInterface dialog, int which ) {
